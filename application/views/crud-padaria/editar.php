...
<body>
    <main>
        ...
        <div class="container ">
            ...
            <?= form_open("dashboard/editarProdutoPadaria", 'id="formsubmit"'); ?>
                ...
                <div class="mt-3">
                    ...
                    <div class="row alinha-buttons mt-2">
                        <div class="col-md-3">
                            ...
                            <input type="tel" id="validade" name="validade" required class="datavalidadepadaria form-control" value="<?= $produto->prazo_validade; ?>">
                        </div>
                    </div>
                </div>
            </div>
